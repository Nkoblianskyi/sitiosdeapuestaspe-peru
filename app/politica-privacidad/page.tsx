        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-gray-200">
          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-10">
              ...
              <p className="text-gray-700 mb-4 leading-relaxed">
                Cumplimos con la Ley de Protección de Datos Personales del Perú (Ley N° 29733) y su reglamento, así como
                con otras regulaciones aplicables de privacidad y protección de datos.
              </p>
            </section>
            ...
            <section className="mb-10">
              ...
              <div className="mb-6">
                <h3 className="text-xl font-semibold text-red-600 mb-3">2.2 Información recopilada automáticamente</h3>
                <p className="text-gray-700 mb-3 leading-relaxed">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Utilizamos cookies y tecnologías similares para mejorar su experiencia. Para más información, consulte
                  nuestra{" "}
              ...
              <div className="space-y-4">
                <div className="p-4 bg-red-50 rounded-lg border border-red-100">
                  ...
                  <p className="text-gray-700 text-sm">
                    Operar, mantener y mejorar nuestro sitio web y los servicios que ofrecemos, incluyendo comparativas
                    de casas de apuestas y recomendaciones personalizadas.
                  </p>
                </div>
                ...
                <div className="p-4 bg-purple-50 rounded-lg border border-purple-100">
                  ...
                  <p className="text-gray-700 text-sm">
                    Mostrar publicidad relevante y personalizada basada en sus intereses y comportamiento de navegación.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="mb-10">
              ...
              <ul className="text-gray-700 list-disc pl-6 space-y-3 mb-4">
                ...
                <li>
                  <strong>Socios comerciales:</strong> Con casas de apuestas asociadas cuando hace clic en sus enlaces o
                  se registra en sus servicios a través de nuestro sitio.
                </li>
                <li>
            ...
            <section className="mb-10">
              ...
              <p className="text-gray-700 leading-relaxed">
                Para ejercer estos derechos, puede contactarnos utilizando la información proporcionada en la sección de
                contacto.
              </p>
            </section>
            ...
            <div className="bg-red-50 border-l-4 border-red-600 p-6 mt-10">
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                El juego puede ser adictivo. Juegue responsablemente y solo con dinero que pueda permitirse perder. Las
                apuestas están prohibidas para menores de 18 años. Este sitio proporciona información comparativa sobre
                casas de apuestas legalmente autorizadas en Perú.
              </p>
            </div>
          </div>
        </div>

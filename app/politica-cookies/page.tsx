            ...
            <div className="prose prose-lg max-w-none">
              <section className="mb-10">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  ...
                  navegación, analizar el tráfico del sitio y personalizar el contenido. Esta política explica qué son
                  las cookies, cómo las utilizamos y cómo puede controlarlas.
                </p>
              </section>
              ...
              <section className="mb-10">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  Las cookies son ampliamente utilizadas para hacer que los sitios web funcionen de manera más eficiente
                  y proporcionar información útil a los propietarios del sitio.
                </p>
              </section>
              ...
              <section className="mb-10">
                ...
                <div className="mb-6 p-6 bg-purple-50 rounded-lg border border-purple-200">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-2">
                    ...
                    También se utilizan para limitar el número de veces que ve un anuncio, así como para ayudar a medir
              ...
              <section className="mb-10">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  Algunos de nuestros socios comerciales pueden establecer cookies en su dispositivo cuando visita
                  nuestro sitio web. Esto puede incluir redes publicitarias, proveedores de análisis y redes sociales.
                  No controlamos estas cookies de terceros y le recomendamos que revise las políticas de privacidad de
                  estos terceros para obtener más información.
                </p>
                <p className="text-gray-700 mb-4 leading-relaxed">
              ...
              <section className="mb-10">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  También puede configurar o modificar los controles de su navegador web para aceptar o rechazar
                  cookies. Si decide rechazar las cookies, aún puede utilizar nuestro sitio web, aunque su acceso a
                  algunas funcionalidades y áreas puede verse limitado.
                </p>
              ...
              <div className="bg-red-50 border-l-4 border-red-600 p-6 mt-10">
                <p className="text-gray-700 leading-relaxed">
                  ...
                  acepta el uso de cookies de acuerdo con esta política. Si no está de acuerdo con el uso de cookies,
                  debe ajustar la configuración de su navegador o abstenerse de utilizar nuestro sitio.
                </p>
              </div>
            </div>
          </div>
